...
package net.ubikapps.batterywatchface;
 ...
 */
public class BatteryWatchFace extends CanvasWatchFaceService {
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<BatteryWatchFace.Engine> mWeakReference;

        public EngineHandler(BatteryWatchFace.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            BatteryWatchFace.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(BatteryWatchFace.this)
        ...
        private void registerReceiver() {
            ...
            BatteryWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            BatteryWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
